layui.use([ 'table', 'element', 'form' ], function() {
	...
	var form = layui.form;
	var url = window.siteUrl + '/res/res_video/list/wait_publish'
	...
	element.on('tab(demo)', function(data) {
		if ($(this).attr('id') == 'waitPublishTab') {
			url = window.siteUrl + '/res/res_video/list/wait_publish';
		} else if ($(this).attr('id') == 'publishTab') {
			url = window.siteUrl + '/res/res_video/list/publish';
		} else if ($(this).attr('id') == 'soldOutTab') {
			url = window.siteUrl + '/res/res_video/list/sold_out';
		}
		table.reload("table", {
			url : url
		})
